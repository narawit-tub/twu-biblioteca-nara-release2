...
import com.twu.biblioteca.bibliotecharelease2.web.HomeController;
...
public class HttpRequestTesting {
    ...
    public void shouldReturnDefaultMessage() throws Exception {
        this.mockMvc.perform(get("/")).andDo(print()).andExpect(status().isOk()).andExpect(content().string(containsString("Welcome to libary!")));
    }
}
